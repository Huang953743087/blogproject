...
class Post(models.Model):
    ...
    modified_time=models.DateTimeField(default=datetime.now, verbose_name=u'最后修改时间')
    # 文章摘要，可以没有文章摘要，但默认情况下 CharField 要求我们必须存入数据，否则就会报错。
    # 指定 CharField 的 blank=True 参数值后就可以允许空值了。
    excerpt=models.CharField(max_length=200,blank=True, verbose_name=u'最后修改时间')
    ...
    author=models.ForeignKey(User, on_delete=models.CASCADE, verbose_name=u'用户')
